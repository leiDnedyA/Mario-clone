...
let samplePosEvent = new OnscreenTextEvent('Use "A", "D", and Space to move', [40, 25], [5, 5], true, 1000);
let samplePosEvent2 = new OnscreenTextEvent('Press "W" to enter the door!', [32, -3], [10, 6], true, 1000);
let samplePosEvent3 = new OnscreenTextEvent('Ty for testing my game <3', [18, 14], [10, 6], true, 1000);
let samplePosEvent4 = new OnscreenTextEvent('Woah good job :O', [70, 30], [5, 5], true, 1000);
let samplePosEvent5 = new OnscreenTextEvent('jk >:D', [80, 39], [20, 6], true, 1000);
